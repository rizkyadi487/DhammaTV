...
class Restore extends CI_Controller {
	...
	public function upload()
	{
		...
		if(!empty($cek))
		{
			...
			{
				$this->db->query("TRUNCATE TABLE dhammadb_daftar_cetak");
				$this->db->query("TRUNCATE TABLE dhammadb_gaji_karyawan");
				$this->db->query("TRUNCATE TABLE dhammadb_nama_crew");
				$this->db->query("TRUNCATE TABLE dhammadb_jenis_kerjaan");
				$this->db->query("TRUNCATE TABLE dhammadb_karyawan");
				$this->db->query("TRUNCATE TABLE dhammadb_kwitansi");
				$this->db->query("TRUNCATE TABLE dhammadb_pelanggan");
				$this->db->query("TRUNCATE TABLE dhammadb_pembayaran");
				$this->db->query("TRUNCATE TABLE dhammadb_pemesanan");
				$this->db->query("TRUNCATE TABLE dhammadb_pemesanan_detail");
				$this->db->query("TRUNCATE TABLE dhammadb_sessions");
				$this->db->query("TRUNCATE TABLE dhammadb_setting");
				$this->db->query("TRUNCATE TABLE dhammadb_user");
