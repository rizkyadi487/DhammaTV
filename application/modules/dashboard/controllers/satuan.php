...
class satuan extends CI_Controller {
	...
	function edit($id_param)
	{
		if($this->session->userdata("logged_in")!="")
		{
			...
			$get = $this->db->get_where("dhammadb_jenis_kerjaan",$id)->row();
	...
	function simpan()
	{
		if($this->session->userdata("logged_in")!="")
		{
			...
			if($st=="tambah")
			{
				$this->db->insert("dhammadb_jenis_kerjaan",$dt);
				redirect("dashboard/satuan");
			}
			else if($st=="edit")
			{
				$this->db->update("dhammadb_jenis_kerjaan",$dt,$id);
				redirect("dashboard/satuan");
			}
		}
		else
	...
	function hapus($id_param)
	{
		...
		{
			$id['id_jenis_satuan'] = $id_param;
			$get = $this->db->delete("dhammadb_jenis_kerjaan",$id);
			redirect("dashboard/satuan");
		}
		else
		{
