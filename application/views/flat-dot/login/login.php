...
<html lang="en">
  <head>
	...
	<link rel="icon" href="<?php echo base_url().'asset/theme/'.$GLOBALS['site_theme']; ?>/img/favicon.ico" type="image/x-icon">
		...
		<?php echo form_open("login/act"); ?>
			...
			<div class="login-actions">
				...
				<input type="submit" class="button btn btn-warning btn-large" value="Sign In"> <input type="reset" class="button btn btn-default btn-large" value="Reset">
                                ...
                                <h5><i class="halflings-icon hdd"></i><span class="break"></span>
                                <i class="halflings-icon plus-sign"></i><a href="<?php echo base_url(); ?>dashboard/pengguna/tambah">Daftar Penguna</a></h5>
			</div>
