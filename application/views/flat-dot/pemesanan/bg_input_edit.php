...
<div class="row-fluid sortable">		
	<div class="box span12">
		...
		<div class="box-content">
			<?php echo form_open_multipart("dashboard/pemesanan/simpan_update",'class="form-horizontal" name="frm_pesan"'); ?>
			  <fieldset>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<select data-placeholder="Cari nama user..." class="chzn-select" style="width:400px;" tabindex="2" name="kode_user" id="kode_user">
          		<option value=""></option> 
					<?php
				...
				<div class="control-group">
          		...
          		<option value=""></option> 
					...
					?>
						<option value="<?php echo $dp['id_jenis_acara']; ?>" <?php echo $pilih2; ?>><?php echo $dp['acara']; ?></option>
					<?php
					}
					else
					{
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					...
					<?php echo $naskah;?><a href="<?php echo base_url().'dashboard/pemesanan/lakukan_download/'.$naskah ?>">Download file</a>
				  </div>
				</div>
